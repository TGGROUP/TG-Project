...
<div id="left-side">
  ...
  <div class="block">
    <img id="photo"><span id="name">Name: <span class="role">Maxik           Kostenko</span></br>Role: <span class="role">Admin</span></span>
  </div>
...
<div id="content">
  ...
  <div class="entity">
    ...
    <div id="f-name"><a href="rooms.html"><span>Building 1</span></a></div>
